...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/answer3for/TRUNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'answer3for' => 'yinyulong0405@126.com' }
  s.source           = { :git => 'https://github.com/answer3for/TRUNetworking.git', :tag => s.version.to_s }
